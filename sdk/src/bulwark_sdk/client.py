"""
HTTP client for communicating with a remote Bulwark Gateway instance.
...
class BulwarkClient:
    ...
    def base_url(self) -> str:
        """The base URL of the Bulwark Gateway."""
    ...
    async def health(self) -> HealthStatus:
        """Check the health of the Bulwark Gateway.
        ...
        try:
            ...
            raise ConnectionError(
                f"Cannot connect to Bulwark Gateway at {self._base_url}",
                url=self._base_url,
            ) from e
    ...
    def _default_headers(self) -> dict[str, str]:
        ...
        return {
            ...
            "User-Agent": "bulwark-gateway-sdk/0.1.0",
    ...
    async def _request(
        ...
        *,
        ...
        try:
            ...
            raise ConnectionError(
                f"Request to Bulwark Gateway timed out after {self._timeout}s",
                url=url,
            ) from e
        except httpx.HTTPError as e:
            raise ConnectionError(
                f"HTTP error communicating with Bulwark Gateway: {e}",
                url=url,
            ) from e
        ...
        if resp.status_code == 401:
            ...
            raise GatewayError(
                f"Bulwark Gateway returned {resp.status_code}",
