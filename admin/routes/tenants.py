...
def _validate_backend_url(url: str) -> None:
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Invalid backend_url format") from None
    ...
    try:
        ...
        if hostname.lower() in _SSRF_BLOCKED_HOSTNAMES:
            raise HTTPException(status_code=400, detail="backend_url targets a blocked hostname") from None
