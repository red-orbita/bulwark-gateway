...
class PrometheusMetrics:
    ...
    def to_prometheus_text(self) -> str:
        ...
        lines = [
            ...
            "# HELP bulwark_latency_p99_ms Request latency p99 in ms",
            "# TYPE bulwark_latency_p99_ms gauge",
            f"bulwark_latency_p99_ms {s.latency_p99_ms:.2f}",
            "# HELP bulwark_uptime_seconds Uptime in seconds",
            "# TYPE bulwark_uptime_seconds gauge",
            f"bulwark_uptime_seconds {s.uptime_seconds}",
            "# HELP bulwark_queue_depth_memory Telemetry queue depth (memory)",
            "# TYPE bulwark_queue_depth_memory gauge",
            f"bulwark_queue_depth_memory {s.queue_depth_memory}",
            "# HELP bulwark_siem_export_errors SIEM export error count",
            "# TYPE bulwark_siem_export_errors counter",
            f"bulwark_siem_export_errors {s.siem_export_errors}",
        ]
        return "\n".join(lines) + "\n"
