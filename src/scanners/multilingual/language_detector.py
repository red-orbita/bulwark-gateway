...
SHIPPED STATE (honesty): backends 1 and 2 are OPTIONAL and NOT installed by
default. Backend 1 (lingua) ships via the ``multilingual`` extra
(``pip install bulwark-gateway[multilingual]``); it is deliberately kept out of
